...
for w0 in w0_values:
    ...
    plt.plot(omega, y, lw=2.5, label=fr'$\omega_0 = {w0}$')
...
for tau in tau_values:
    ...
    plt.plot(omega, y, lw=2.5, label=fr'$\tau = {tau}$')
...
plt.plot(omega, y_single, lw=2.5, color='#2ca02c', label=fr'$\omega_0 = {w0_single}, \tau = {tau_single}$')
