...
sol = solve_ivp(
    lambda t, y: rlc_system(t, y, lambda t: T0), t_span, [0, V0], t_eval=t_eval
)
I = sol.y[0]
V_C = sol.y[1]
t = sol.t
...
sol2 = solve_ivp(
    lambda t, y: rlc_system(t, y, T_interp), t_span, [0, V0], t_eval=t_eval
)
I2 = sol2.y[0]
V_C2 = sol2.y[1]
